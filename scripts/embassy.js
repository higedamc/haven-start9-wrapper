...
const getConfig1 = mod3.getConfig({
    ...
    "private-relay-max-event-size": {
        "type": "number",
        "name": "Private Relay - Max Event Size (KB)",
        "description": "Maximum event size in KB for Private Relay. Recommended: 128KB for normal use, 512KB for long-form content (kind 30023).",
        "nullable": false,
        "default": 128,
        "range": "[64,2048]",
        "integral": true
    },
    "chat-relay-max-event-size": {
        "type": "number",
        "name": "Chat Relay - Max Event Size (KB)",
        "description": "Maximum event size in KB for Chat Relay. Direct messages are usually small, so 128KB is sufficient.",
        "nullable": false,
        "default": 128,
        "range": "[64,512]",
        "integral": true
    },
    "outbox-relay-max-event-size": {
        "type": "number",
        "name": "Outbox Relay - Max Event Size (KB)",
        "description": "Maximum event size in KB for Outbox Relay. This affects public posts. Recommended: 128KB for normal posts.",
        "nullable": false,
        "default": 128,
        "range": "[64,1024]",
        "integral": true
    },
    "inbox-relay-max-event-size": {
        "type": "number",
        "name": "Inbox Relay - Max Event Size (KB)",
        "description": "Maximum event size in KB for Inbox Relay. This affects incoming tagged events. Recommended: 128KB.",
        "nullable": false,
        "default": 128,
        "range": "[64,1024]",
        "integral": true
    ...
    "enable-kind-specific-limits": {
        ...
        "description": "Allow larger events for long-form content kinds (30023, 30024, 30040, 30041). If enabled, long-form articles can be up to the configured long-form content size.",
        "nullable": false,
        "default": true
    },
    "max-long-form-content-size": {
        ...
        "description": "Maximum event size for long-form content (Kind 30023: articles, 30024: drafts). Only applies if Kind-Specific Limits are enabled. Recommended: 1024KB (1MB) for full article support.",
        "nullable": false,
        "default": 1024,
        "range": "[128,4096]",
        "integral": true
